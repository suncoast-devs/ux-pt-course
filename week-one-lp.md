...
So, UX is all about the way a user experiences an applictaion, and UI is all about the way a user interacts with an application. Sounds like *almost* the same thing, right? 
